...
<%@ page import="com.pokemon.dto.PlaceDTO"%>
			...
			<li class="proList" style="margin-top: 0px;">
				...
				%> <a class="search-result"> <!-- detailed page if can -->
					<div class="pokemon">
						...
						<input type="button" id="type2" value="<%=poke.getType2()%>"
							style="width:30%;background:<%=poke.getColor2()%>;border:none; border-radius:5px;">
						<%
						}
						%>
						<h4>
